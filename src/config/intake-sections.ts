  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "checkbox",
        options: ["Lending / Loan Operations", "Deposit Operations", "Compliance / BSA / Risk", "Commercial Banking / Business Development", "Retail / Branch Banking", "Finance & Accounting", "HR & People", "IT / Information Security", "Other"],
